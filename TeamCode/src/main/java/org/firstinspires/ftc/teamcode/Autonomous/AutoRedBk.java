...
@Autonomous(name = "AutoRedBk")
public class AutoRedBk extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            move2(0.4,0.4,0.4,0.4,kd,kp,230.0,0);
            ...
            //Sample 3
            move2(0.4,0.4,0.4,0.4,kd,kp,25.0,45);
            move2(-0.5,0.5,-0.5,0.5,kd,kp,160.0,90);
            move2(0.4,0.4,0.4,0.4,kd,kp,535.0,90);
            sleep(100);
            Wrist.setPosition(1);
            sleep(600);
            neep.setPosition(0);
