...
public class AutoBlueSp extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            sleep(400);
            move2(0.4,0.4,0.4,0.4,kd,kp,570.0,-90);
            move2(0.22,0.22,0.22,0.22,kd,kp,250.0,-90);
            sleep(200);
            neep.setPosition(0);
            sleep(900);
            Wrist.setPosition(0.75);
            servo_wolfpack(0.4);
            move2(-0.4,-0.4,-0.4,-0.4,kd,kp,1060.0,-90);
            ...
            //KeepSp3
            move2(-0.4,-0.4,-0.4,-0.4,kd,kp,330.0,0);
            neep.setPosition(0.1);
            ...
            move2(0.55,-0.55,-0.55,0.55,kd,kp,2100.0,0);
